    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-xs text-cyan-600 bg-cyan-50 px-3 py-1.5 rounded-full border border-cyan-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {/* Total Items - Cyan (role color) */}
        <div className="p-4 border border-cyan-200 rounded-lg bg-cyan-50">
          <div className="flex items-center gap-2 mb-2">
            <div className="p-1.5 bg-cyan-100 rounded">
              <Package className="h-4 w-4 text-cyan-600" />
            </div>
            <span className="text-xs text-cyan-700 font-medium uppercase tracking-wide">Total Items</span>
          </div>
          <p className="text-3xl font-bold text-cyan-900">{loading ? '–' : stats.totalItems}</p>
        </div>
